...
struct WallTexture {
    ...
    [[nodiscard]] std::vector<Pixel> get_scaled_column(const size_t texture_id, const size_t tex_coord, const size_t column_height) const; // Поулчаем колонну текстуры
};
